...
# This notebook needs four parquet data files to run, which are generated by the notebook `manuscript_data-prep.py`
#
...
#
# After you have successfully run the data prep notebook, just execute this one to produce all figures and tables.
